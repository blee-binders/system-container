...
####+END
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :title "Enable Development" :anchor "" :extraInfo "Activates BISOS-Dev Credentials BPO"
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(org-cycle)][| *Enable Development:* |]]  Activates BISOS-Dev Credentials BPO  [[elisp:(org-shifttab)][<)]] E|
####+END
